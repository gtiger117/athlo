...
class GetActiveSizesController extends Controller
{
    public function get_active_sizes(Request $request)
    {
        
       $main_char_id = env('SIZE_ID');
       ...
       foreach ($query as $key=>$row) {
            ...
            if(in_array($row->id, $sizes_array)){
