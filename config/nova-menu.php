...
return [
    ...
    */
    ...
    'menus' => [
        'main' => ['name' => 'Main', 'unique' => true, 'menu_item_types' => []],
        'nova_menu' => ['name' => 'Nova Menu', 'unique' => true, 'menu_item_types' => []],
        'category' => ['name' => 'Category', 'unique' => true, 'menu_item_types' => []],
        'other' => ['name' => 'Other', 'unique' => false, 'menu_item_types' => []],
    ],
